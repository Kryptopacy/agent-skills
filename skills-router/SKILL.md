...
5. **Before claiming done**, load `verification-before-completion`.
6. **If you used a skill not listed here**, add it to the **Pending Review** section at the bottom — never to the live tables.
